...
export function FinalCTA() {
  return (
    <section className="py-20 md:py-40 bg-gradient-to-br from-navy to-ink relative overflow-hidden">
      <div
      ...
      <div className="container-x relative">
        <RevealOnScroll>
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="mt-8 font-display text-h2 md:text-h1 text-mist text-balance leading-[1.05]">
